...
def build_providers(
    ...
    open_library = OpenLibraryProvider(
        CachedProviderClient(
            ...
            normalization_schema_version=OpenLibraryProvider.normalization_schema_version,
    ...
    google = GoogleBooksProvider(
        CachedProviderClient(
            ...
            timeout=settings.timeout_seconds,
            ttl_seconds=settings.cache_ttl_seconds,
            normalization_schema_version=GoogleBooksProvider.normalization_schema_version,
            offline=settings.offline,
        ),
